...
values (2, '5b36246b-e7a1-431f-99db-08daafe9bc5b', 'user@example.com', 'User TEST', 'user@example.com',
        '0000000000', '111',
        null, 'Aberdeen', 'WA', '00', 'US', 'NEW', null, null, null),
       (3, 'aecceefc-dbb0-4653-9021-39195f658065', 'user@example.com', 'User TEST2', 'user2@example.com',
        '0000000000', '222',
